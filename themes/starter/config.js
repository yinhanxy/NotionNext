...
const CONFIG = {
  ...
  STARTER_HERO_TITLE_1: '量身定制', // 英雄区文字
  STARTER_HERO_TITLE_2: '为你打造专属健身计划', // 英雄区文字
  ...
  STARTER_HERO_PREVIEW_IMAGE: 'https://raw.githubusercontent.com/yinhanxy/pic/main/sports-3.jpeg', // 产品预览图 ，默认读取public目录下图片
  ...
  STARTER_ABOUT_TITLE: '一套实用的健身解决方案',
  STARTER_ABOUT_TEXT:
    'Fit的愿景是帮助非技术人员的小白，最低成本、最快速地搭建自己的网站，帮助您将自己的产品与故事高效地传达给世界。 <br /> <br /> 功能强大的Notion笔记，简单快速的Vercel托管平台，组成一个简单的网站',
  STARTER_ABOUT_BUTTON_TEXT: '了解更多',
  STARTER_ABOUT_BUTTON_URL: 'https://raw.githubusercontent.com/yinhanxy/pic/main/sports-2.jpeg',
  STARTER_ABOUT_IMAGE_1: '/images/starter/about/about-image-01.jpg',
  STARTER_ABOUT_IMAGE_2: '/images/starter/about/about-image-02.jpg',
  STARTER_ABOUT_TIPS_1: '7000+',
  STARTER_ABOUT_TIPS_2: '用户选择',
  STARTER_ABOUT_TIPS_3: '绝对好评',
  ...
  STARTER_TESTIMONIALS_TEXT_2:
    '数千位用户选择用NotionNext搭建他们的网站,通过帮助手册、交流社群以及技术咨询，大家成功上线了自己的网站',
  ...
  STARTER_FOOTER_LINK_GROUP: [
    {
      ...
      LINK_GROUP: [
        { TITLE: '官方主页', URL: '/#home' },
        { TITLE: '操作文档', URL: 'https://sports.geekwy.fun/' },
        {
          TITLE: '帮助支持',
          URL: 'https://sports.geekwy.fun/'
        },
        {
          TITLE: '合作申请',
          URL: 'https://sports.geekwy.fun/'
    ...
    },
    {
      ...
      LINK_GROUP: [
        ...
        { TITLE: '数据记录', URL: 'https://sports.geekwy.fun/' }
      ]
    }
    // ,
    // {
